...
for row in data:
    ...
    # print("donr:")
    c.execute(insert_query,(row['Name'],row['USN'],row['Graduation year'],class_id[0],row['Blood group'],row['Parent/Guardian Name'], row['Parent/Guardian Phone number'],row['Parent/Guardian Email'], row['Address'],row['Address'],row['10th result'],row['12th result'],img[i]))
    i+=1
